...
\begin{figure}[ht]
    \begin{tikzpicture}
        ...
        \draw (8.1,3.175) node[color=blue,cross] {};
        \draw (8.4,3.25) node[color=blue,cross] {};
        \draw (8.7,3.4) node[color=blue,cross] {};
        \draw (9.0,3.5) node[color=blue,cross] {};
        \draw (9.3,3.65) node[color=blue,cross] {};
        \draw (9.6,3.75) node[color=blue,cross] {};
