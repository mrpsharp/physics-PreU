% include later \documentclass[main.tex]{subfiles}
...
\item Define and use the radian
...
\item  Understand the concept of angular velocity, and recall and use the equations $v = r \omega $
...
Example question: Calculate the linear velocity of the Earth relative to the sun, given the Earth-Sun distance is 1.5 x $10^{11} $m
