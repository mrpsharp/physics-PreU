...
\usepackage{titlesec}
\usepackage{tikz}
\usepackage[european,siunitx]{circuitikzgit}
\usepackage{amsmath}
\usepackage{lmodern}
\usepackage{amssymb}
\usepackage{wrapfig}
...
%sagemathcloud={"latex_command":"latexmk -pdf -f -g -bibtex -synctex=1 -interaction=nonstopmode 'main.tex'"}
