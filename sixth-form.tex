...
Angular velocity is defined as the rate of change of angle, $\omega = \frac{d\theta}{dt}$ -- i.e., how many radians per second the rotating object passes through. Hence, the time for one complete rotation will be $T = \frac{2\pi}{\omega}$.
