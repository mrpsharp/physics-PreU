...
\begin{example}
  A kettle with a power rating of \SI{2}{\kilo\watt} heats \SI{500}{\gram} of water from \SI{15}{\celsius} to boiling. If the kettle is 80\% efficient, calculate the time taken for the water to boil.
