...
\spec{relate resultant force to rate of change of momentum in situations where mass is constant and recall
 and use $F = \frac{\Delta P}{\Delta t}$}
...
\spec{recall and use p = ρgh for pressure due to a liquid.}
